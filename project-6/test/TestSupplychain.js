...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function buildCarPart() that allows a CarFactory to build Car Part car", async() => {
        ...
        let result = await supplyChain.buildCarPart(upc, originCarFactoryID, originCarFactoryName, originCarFactoryInformation, originCarFactoryLatitude, originCarFactoryLongitude, productNotes, { from: originCarFactoryID })
        ...
        assert.equal(resultBufferTwo[5], 0, 'Error: Invalid car State') // 0 = CarPartBuilt
        truffleAssert.eventEmitted(result, 'CarPartBuilt', null, 'Invalid event emitted');
    })
    ...
    it("Testing smart contract function buildCar() that allows a CarFactory to build car", async() => {
        ...
        let result = await supplyChain.buildCar(upc, { from: originCarFactoryID });
        ...
        truffleAssert.eventEmitted(result, 'CarBuilt', null, 'Invalid event emitted');
    })
    ...
    it("Testing smart contract function sellCar() that allows a CarFactory to sell car", async() => {
        ...
        let result = await supplyChain.sellCar(upc, productPrice, { from: originCarFactoryID })
    ...
    it("Testing smart contract function buyCar() that allows a dealer to buy car", async() => {
        ...
        let result = await supplyChain.buyCar(upc, { from: dealerID, value: productPrice })
    ...
    it("Testing smart contract function shipCar() that allows a dealer to ship car", async() => {
        ...
        let result = await supplyChain.shipCar(upc, { from: dealerID })
        ...
        truffleAssert.eventEmitted(result, 'Shipped', null, 'Invalid event emitted');
    })
    ...
    it("Testing smart contract function receiveCar() that allows a dealer to mark car received", async() => {
        ...
        // Mark an car as Sold by calling function buyCar()
        let result = await supplyChain.receiveCar(upc, { from: dealerID })
    ...
    it("Testing smart contract function purchaseCar() that allows a consumer to purchase car", async() => {
        ...
        // Mark an car as Sold by calling function buyCar()
        let result = await supplyChain.purchaseCar(upc, { from: consumerID })
    ...
    it("Testing smart contract function fetchCarBufferTwo() that allows anyone to fetch car details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[5], 6, 'Error: Missing or Invalid car State') // 6 = Purchased
